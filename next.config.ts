...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      // Old service slugs → hub (replaced by 4 custom plans)
      ...
      { source: '/es/servicios/estrategia-digital', destination: '/es/servicios/consultoria', permanent: true },
      ...
      { source: '/es/servicios/storytelling', destination: '/es/servicios/asesoria', permanent: true },
      ...
      { source: '/en/services/digital-strategy', destination: '/en/services/consulting', permanent: true },
      ...
      { source: '/en/services/storytelling', destination: '/en/services/advisory', permanent: true },
