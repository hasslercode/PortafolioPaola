    ...
    <dialog ref={dialogRef} className="contact-modal" id="contact-modal" aria-labelledby="contact-modal-title" onClose={onClose}>
      ...
      <div className="contact-modal__panel">
        ...
        <ul className="contact-modal__channels">
          <li>
            <a href="mailto:pahoyoscardona@gmail.com" className="contact-modal__channel">
          ...
          <li>
            <a href="tel:+573002493331" className="contact-modal__channel">
              <span className="contact-modal__channel-icon" aria-hidden="true">
          ...
          <li>
            <a href="https://instagram.com/paolaahoyosc" className="contact-modal__channel" target="_blank" rel="noopener noreferrer">
              <span className="contact-modal__channel-icon" aria-hidden="true">
        ...
        <a className="contact-modal__wpp" href={whatsappUrl} target="_blank" rel="noopener noreferrer">
