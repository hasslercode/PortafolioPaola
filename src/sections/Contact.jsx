...
export default function Contact({ onOpenContact }) {
  ...
  return (
    <section className="cta-banner-final" id="contacto">
      ...
      <div className="cta-vertical-divider" />
