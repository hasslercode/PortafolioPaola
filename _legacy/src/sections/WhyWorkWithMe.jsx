...
const WHY_PHOTO_WEBP_300 = `${PHOTO_BASE}assets/fotopaola3-300.webp`;
const WHY_PHOTO_WEBP_560 = `${PHOTO_BASE}assets/fotopaola3-560.webp`;
const WHY_PHOTO_JPG = `${PHOTO_BASE}assets/fotopaola3.jpg`;
  ...
  return (
    <section className="why-me" id="por-que-yo" aria-labelledby="why-me-title">
      <div className="container">
        ...
        <div className="why-me__layout">
          <FadeUp className="why-me__photo" index={1}>
            <picture>
              <source
                type="image/webp"
                srcSet={`${WHY_PHOTO_WEBP_300} 300w, ${WHY_PHOTO_WEBP_560} 560w`}
                sizes="(max-width: 900px) 340px, 340px"
              />
              <img
                src={WHY_PHOTO_JPG}
                alt={whyWorkWithMe.imageAlt}
                className="why-me__photo-img"
                width={300}
                height={442}
                loading="lazy"
                decoding="async"
          ...
          <div className="why-me__grid">
            {whyWorkWithMe.pillars.map((pillar, index) => (
              <FadeUp key={pillar.title} as="article" className="why-me__card" index={index + 2}>
