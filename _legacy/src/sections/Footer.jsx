      ...
      <div className="container">
        <div className="footer-main-grid">
          <div className="footer-col-brand">
            <div className="footer-brand-block">
              <div className="footer-logo-glow">
                <img src={iconPaola} alt={footer.logoAlt} className="footer-logo-image" width="72" height="72" loading="lazy" decoding="async" />
              </div>
          ...
          <div className="footer-col-links">
            ...
            <ul>
              <li><a href="#inicio">{footer.nav.inicio}</a></li>
              <li><a href="#experiencias-destacadas">{footer.nav.experiencias}</a></li>
              <li><a href="#servicios">{footer.nav.servicios}</a></li>
              <li><a href="#" onClick={handlePortfolioClick} aria-haspopup="dialog">{footer.nav.portafolio}</a></li>
              <li><a href="#competencias">{footer.nav.recursos}</a></li>
              <li><a href="#contacto">{footer.nav.contacto}</a></li>
            </ul>
          </div>
